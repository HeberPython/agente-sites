"""Revision-guarded WordPress release for the researched multimeter guide."""
...
SLUG = "best-multimeters-under-50-for-home-electricians-2025"
POST_ID = 53
TITLE = "Multimeters for Home Electrical Troubleshooting"
SEO_TITLE = TITLE + " | HandyTested"
DESCRIPTION = "Compare Klein MM325, Klein MM420 and Fluke 110 multimeters using documented CAT ratings, measurement functions and buyer trade-offs."
CONTENT = (ROOT / "handytested_phase4_multimeters.html").read_text(encoding="utf-8")
SOURCE = ROOT / "handytested_sources" / (SLUG + ".md")
SNAPSHOT = ROOT / "handytested_sources" / "public_snapshot.json"
MODE = os.getenv("MODE", "dry-run")
BACKUP = Path(os.getenv("BACKUP_DIR", "handytested-phase4-multimeter-backup"))
...
def main() -> None:
    ...
    products = {"Klein Tools MM325", "Klein Tools MM420", "Fluke 110"}
