"""Revision-guarded WordPress release for outdoor furniture kits."""
...
SLUG = "best-diy-outdoor-furniture-kits-under-300-for-2025"
POST_ID = 164
TITLE = "Outdoor Furniture Kits: Build From Lumber or Assemble Parts"
SEO_TITLE = TITLE + " | HandyTested"
DESCRIPTION = "Compare two 2x4 Basics bracket kits and Keter Solana storage bench by included parts, lumber cost, assembly and outdoor-care requirements."
CONTENT = (ROOT / "handytested_phase4_outdoor_furniture.html").read_text(encoding="utf-8")
SOURCE = ROOT / "handytested_sources" / (SLUG + ".md")
SNAPSHOT = ROOT / "handytested_sources" / "public_snapshot.json"
MODE = os.getenv("MODE", "dry-run")
BACKUP = Path(os.getenv("BACKUP_DIR", "handytested-phase4-outdoor-furniture-backup"))
PRODUCTS = {"AnySize Chair 90134ONLMI", "90182ONLMI", "Keter Solana 250294"}
RELATED = ("/best-home-diy-tool-sets-for-under-300-in-2025/", "/best-portable-outdoor-grills-under-300-for-2025/")
...
def main() -> None:
    ...
    try:
        ...
        print("Release failed; attempting rollback of outdoor furniture article", flush=True)
