"""Revision-guarded WordPress release for premium wireless earbuds."""
...
SLUG = "best-wireless-earbuds-under-300-for-2025"
POST_ID = 179
TITLE = "Premium Wireless Earbuds: Apple, Samsung and Bose Compared"
SEO_TITLE = TITLE + " | HandyTested"
DESCRIPTION = "Compare AirPods Pro 3, Galaxy Buds4 Pro and Bose QC Ultra Earbuds 2nd Gen by ecosystem, fit, battery conditions and water ratings."
CONTENT = (ROOT / "handytested_phase4_premium_earbuds.html").read_text(encoding="utf-8")
SOURCE = ROOT / "handytested_sources" / (SLUG + ".md")
SNAPSHOT = ROOT / "handytested_sources" / "public_snapshot.json"
MODE = os.getenv("MODE", "dry-run")
BACKUP = Path(os.getenv("BACKUP_DIR", "handytested-phase4-premium-earbuds-backup"))
PRODUCTS = {"AirPods Pro 3", "Galaxy Buds4 Pro", "Bose QuietComfort Ultra Earbuds (2nd Gen)"}
RELATED = ("/best-wireless-earbuds-under-100-for-2025/", "/best-noise-canceling-headphones-under-300-for-2025/")
...
def main() -> None:
    ...
    try:
        ...
        print("Release failed; attempting rollback of premium earbuds article", flush=True)
